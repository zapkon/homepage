...
This post showcase what we can learn from GDELT about the country of Mozart, [Schnitzel](http://www.brigittenauerstadl.at/index.html) and Red Bull. Credits to [Viktor](https://twitter.com/martino_vic) for assistance!
...
The plot indicates the 7 (out of 150) most frequent event categories in which context Austria was mentioned with one of the 5 countries. Dots represent the weekly sentiment (AvgTone). We see that during March/April the dots are very red - bad sentiment is explained simply by COVID-19 epidemy.
