...
You can download all GDELT Event Files per day [here](http://data.gdeltproject.org/events/index.html). Respectivly the [codebook](http://data.gdeltproject.org/documentation/GDELT-Event_Codebook-V2.0.pdf).
