...
This post showcase what we can learn from GDELT about the country of Mozart, Schnitzel and Red Bull (Austria). Cretits to [Viktor](https://twitter.com/martino_vic) for assistance!

News Media from all corners of the earth are crawled by the algorithm. It extracts and codifies systematically the information, such as Date, [CAMEO Event](http://data.gdeltproject.org/documentation/CAMEO.Manual.1.1b3.pdf), Sentiment, Entities such as Persons, Organisations, GeoLocations Countries and much more.
