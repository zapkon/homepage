...
The post-processed dataset looks this: ![alt]({{ site.url }}{{ site.baseurl }}/images/GDELT/data screenshot.jpg)
...
The data was retrieved via API in .R and as I know many people have problems with retrieving the data I wrote a function to smoothly download the data (~ 10 MB per day). A part of the GDELT project is also hosted on [Google BigQuery](https://console.cloud.google.com/bigquery?p=gdelt-bq&d=gdeltv2&page=dataset&project=gdelt-265500&folder=&organizationId=) A filtering of parameter and country == Austria is applied here:
