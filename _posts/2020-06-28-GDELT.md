...
You can customize the input - start_date, end_date, steps and country_code to get the data. I´ve applied a filtering of 25 parameter and country == Austria here:
